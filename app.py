...
# City selection (used in other sections)
...
# GENERAL TRENDS SECTION
    ...
    # Select report type for trends: City Trends, City Map, or Radar Chart
    ...
    if city_report_type == "City Trends":
        ...
        if not cities_selected:
            ...
            title = f"{radar_type} Radar Chart for {', '.join(cities_selected)}"
            fig.update_layout(
                polar=dict(
